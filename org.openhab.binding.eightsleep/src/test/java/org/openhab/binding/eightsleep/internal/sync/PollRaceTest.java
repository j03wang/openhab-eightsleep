...
public class PollRaceTest {
    ...
    public void commandIssuedMidPollWins() {
        ...
        Boolean resolved = LastWriteWins.resolveLatest(true /* stale pre-command data */, pollStarted,
                new CommandedValue(commandAt, false));
    ...
    public void freshObservationAfterCommandWins() {
        ...
        Boolean resolved = LastWriteWins.resolveLatest(false /* server now reflects app-side change */,
                pollStartedAfter, new CommandedValue(commandAt, true));
